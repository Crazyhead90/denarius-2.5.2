...
unsigned int nStakeMinAge       = 1 * 1 * 1;      // 8 hour min stake age
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (fTestNet)
    {
        ...
        nStakeMinAge = 1; // test net min age is 1 hour
    ...
    if (mapBlockIndex.empty())
    {
        ...
        {
        CTransaction txNew;
      	txNew.nTime    = 1526908573;

        CBlock block;
	block.nTime    = 1526908573;
	block.nNonce   = 85359;
        }
...
if (hashGenesisBlockTestNet <= bnProofOfWorkLimit.getuint256()) break;
}
//
