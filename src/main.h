...
static const int64_t MAX_MONEY = 1000000000 * COIN; // 10,000,000 DNR Denarius Max
static const int64_t COIN_YEAR_REWARD = 0.06 * COIN; // 6% per year

static const int64_t MAINNET_POSFIX = 0; //Mainnet Proof of Stake update not enabled until block 640k
